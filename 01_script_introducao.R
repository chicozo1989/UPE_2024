...
setwd("C:/Users/franc/OneDrive/Documents/workshop_UPE")
...
##Esta função sumariza as variáveis de acordo com três variáveis,municipio, ano e mês
...
#8. Alguns indices de variabilidade -> Usaremos o pacote ClimInd--------------------------------
...
#Longest Wet Period -> Sequência de dias chuvosos por mês
cwd(data=Prec,time.scale = "month")
#Heavy precipitation days -> Quantidade de dias com precipitação acima de 50mm
d50mm(data=Prec,time.scale = "year")
#Longest Dry Period -> Sequência de dias secos
cwd(data=Prec,time.scale = "year")
...
#10. Possibilidades com o Pacote OpenAir
